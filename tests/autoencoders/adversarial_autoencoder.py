from autoencoders import AdversarialAutoencoder
...
model = AdversarialAutoencoder(input_dims=[28, 28, 1], hidden_dim=1000, latent_dim=2)
...
model.fit(train_images, epochs=epochs, batch_size=batch_size, callbacks=[LogCallback()])
